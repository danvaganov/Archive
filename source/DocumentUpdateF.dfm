object DocumentUpdateForm: TDocumentUpdateForm
  ...
  object DocumentPageControl: TPageControl
    ...
    object TabSheet4: TTabSheet
      ...
      object DBGridEh3: TDBGridEh
        ...
        Options = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgConfirmDelete, dgCancelOnExit]
        TabOrder = 0
        OnDblClick = EditNotificationDocumentExecute
        Columns = <
          item
            DynProps = <>
            EditButtons = <>
            ...
            Footers = <>
            Title.Caption = #1058#1080#1087' '#1080#1079#1084#1077#1085#1077#1085#1080#1103
            Width = 237
          end
          item
            DynProps = <>
            ...
            Footers = <>
            Title.Caption = #1048#1079#1074#1077#1097#1077#1085#1080#1077
            Width = 153
          end
          item
            DynProps = <>
  ...
  object MSChildDocumentQuery: TMSQuery
    ...
    object MSChildDocumentQuery__5: TDateTimeField
  ...
  object ActionManager1: TActionManager
    ActionBars = <
      ...
      item
        Items = <
          item
            Action = AddNotificationDocument
            ImageIndex = 2
          end
          item
            Action = EditNotificationDocument
            ImageIndex = 0
          end
          item
            Action = DeleteNotificationDocument
            ImageIndex = 1
          end>
    ...
    object AddNotificationDocument: TAction
      Category = 'Notification'
      Caption = #1044#1086#1073#1072#1074#1080#1090#1100
      ImageIndex = 2
      OnExecute = AddNotificationDocumentExecute
    end
    object EditNotificationDocument: TAction
      Category = 'Notification'
      Caption = #1048#1079#1084#1077#1085#1080#1090#1100
      ImageIndex = 0
      OnExecute = EditNotificationDocumentExecute
    end
    object DeleteNotificationDocument: TAction
      Category = 'Notification'
      Caption = #1059#1076#1072#1083#1080#1090#1100
      ImageIndex = 1
      OnExecute = DeleteNotificationDocumentExecute
    end
  end
  ...
  object frxDBChildDocumentDataset: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      #1044#1072#1090#1072'_'#1057#1087#1080#1089#1072#1085#1080#1103'_'#1044#1086#1082#1091#1084#1077#1085#1090'='#1044#1072#1090#1072'_'#1057#1087#1080#1089#1072#1085#1080#1103'_'#1044#1086#1082#1091#1084#1077#1085#1090)
    DataSource = MSChildDocumentDataSource
    BCDToCurrency = False
    Left = 48
    Top = 168
  ...
  object MSNotificationQuery: TMSQuery
    SQLRefresh.Strings = (
        ...
        't";1(:'#1050#1083#1102#1095'_'#1044#1086#1082#1091#1084#1077#1085#1090'_'#1048#1079#1074#1077#1097#1077#1085#1080#1077', :'#1050#1083#1102#1095'_'#1044#1086#1082#1091#1084#1077#1085#1090')}')
    Connection = ArchiveDataModule.MSArchiveConnection
    SQL.Strings = (
    ...
    object MSNotificationQuery_2: TIntegerField
      FieldName = #1050#1083#1102#1095'_'#1044#1086#1082#1091#1084#1077#1085#1090
    end
    object MSNotificationQuery__: TIntegerField
      FieldName = #1050#1083#1102#1095'_'#1044#1086#1082#1091#1084#1077#1085#1090'_'#1048#1079#1074#1077#1097#1077#1085#1080#1077
      ReadOnly = True
    end
    object MSNotificationQuery__2: TIntegerField
    ...
    object MSNotificationQuery___: TIntegerField
    ...
    object MSNotificationQuery__5: TDateTimeField
      FieldName = #1044#1072#1090#1072'_'#1044#1086#1082#1091#1084#1077#1085#1090'_'#1048#1079#1074#1077#1097#1077#1085#1080#1077
    end
  end
